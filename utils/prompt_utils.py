...
def get_slot_update_message(scene_name, slot_template, user_input):
    message = scene_prompts.slot_update.format(scene_name, get_current_date(), json.dumps(get_slot_update_json(slot_template), ensure_ascii=False), user_input)
    return message
